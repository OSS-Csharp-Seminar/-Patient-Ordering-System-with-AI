...
public static class DataAccessDependencyInjection
{
    ...
    {
        services.AddScoped<SpecializationRepository, AuthorRepository>();
        services.AddScoped<IBookRepository, BookRepository>();
        services.AddScoped<DoctorRepository, WorkRepository>();
        services.AddScoped<ILoanRepository, LoanRepository>();
        services.AddScoped<OrderRepository, UserRepository>();
    }
